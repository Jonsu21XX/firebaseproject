    ...
    <div class="create-post">
        ...
        <div class="container">
            ...
            <div class="blog-actions">
                ...
                <router-link class="router-button" :to="{name: 'BlogPreview'}">Preview</router-link>
            </div>
        </div>
    </div>
</template>
    ...
    methods: {
        ...
        uploadBlog() {
            if (this.blogTitle.length !== 0 && this.blogHTML.length !== 0) {
                ...
                this.error = true;
                this.errorMsg = "Missing cover photo.";
                setTimeout(() => {
                    this.error = false;
                }, 5000);
                return;
...
<style lang="scss">
    .create-post{
        ...
        .router-button{
            ...
            &:hover{
                background-color: rgba(48, 48, 48, $alpha: 0.7);
            }
        }
